        ...
        <aside class="profil-sidebar">
          ...
          <div class="quick-info-card glass-card">
            ...
            <div class="social-links">
              ...
              <a href="<?php echo $entreprise['twitter']; ?>" target="_blank" class="social-link" title="Twitter">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="profil-main">
          ...
          <section id="offres" class="profil-section glass-card">
            <div class="section-header-inline">
              ...
              <a href="/entreprise/<?php echo $entreprise['id']; ?>/offres" class="link">Voir tout →</a>
            </div>
